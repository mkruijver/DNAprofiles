...
#' @details The function randomly samples DNA profiles according to the supplied allelic frequencies. The function assumes HW-equilibrium, so the alleles are independent multinomial samples.
...
#' @export
sample.profiles <- function(N, freqs){  
...
#' 
#' @export
sample.relatives <- function(x,N,type="FS",freqs){
